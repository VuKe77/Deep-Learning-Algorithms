...
class TestBatchNorm(unittest.TestCase):
    ...
    def test_reformat_vec2image(self):
        ...
        # I think there's bug, otherwise, it can't explain why (0, 2, 3)is right while (0, 1, 2 )is not 15750->14130
        self.assertEqual(np.sum(image_tensor, (0, 1, 2))[0], 14130, msg="Error: wrong shape. In order to understand how"
                                                           " to implement the reformat function take a look at"
                                                           " the Regularization pdf. Notice that the reformat function "
                                                           "should take care of both cases: reshape an image to a vector"
                                                           " and viceversa.")
